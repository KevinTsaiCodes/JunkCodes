...
#            molded_images, image_metas, _ = self.mold_inputs(images)#將圖片縮放，歸一，預設傳回值是window補0後的真實座標
#        else:
...
#        
#        # Anchors
#        anchors = self.get_anchors(image_shape)#根據圖片大小獲得錨點
#        # Duplicate across the batch dimension because Keras requires it
#        # TODO: can this be optimized to avoid duplicating the anchors?
...
#            image_id = image_ids[image_index]#娶一個索引ID
#
